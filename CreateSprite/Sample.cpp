...
void   Sample::Init()
{
	...
	std::wstring texPath = L"../../data/Number/"; //0.png
	...
	objScreen.Create(m_pd3dDevice.Get(), m_pContext, rtBk, L"../../data/bk.bmp", L"../../data/shader/Default.txt");

	m_UIList.resize(3);

	m_UIList[0].Create(m_pd3dDevice.Get(), m_pContext, { 0, 0, 100, 100 }, L"../../data/kgca1.png", L"Alphablend.hlsl");
	m_UIList[1].Create(m_pd3dDevice.Get(), m_pContext, { 700, 0, 800, 100 }, L"../../data/kgca2.png", L"Alphablend.hlsl");
	m_UIList[2].Create(m_pd3dDevice.Get(), m_pContext, { 700, 500, 800, 600 }, L"../../data/kgca3.png", L"Alphablend.hlsl");
	hero.Create(m_pd3dDevice.Get(), m_pContext, { 350, 250, 450, 350 }, L"../../data/Sprite/bitmap1Alpha.bmp", L"Alphablend.hlsl");
	...
	for (int iNpc = 0; iNpc < 10; iNpc++)
	{
		...
		npc.Create(m_pd3dDevice.Get(), m_pContext,
			...
			L"../../data/Sprite/bitmap1Alpha.bmp", L"Alphablend.hlsl");
