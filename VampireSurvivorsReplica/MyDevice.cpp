#include "MyDevice.h"
#include "MyStd.h"
ComPtr<ID3D11Device>		MyDevice::m_pd3dDevice = nullptr;
ID3D11DeviceContext*		MyDevice::m_pContext = nullptr;
IDXGISwapChain*				MyDevice::m_pSwapChain = nullptr;
ID3D11RenderTargetView*		MyDevice::m_pRTV = nullptr;
D3D11_VIEWPORT				MyDevice::m_ViewPort;
