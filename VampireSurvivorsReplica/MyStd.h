...
#define SAMPLE_END };
#define T_GAME_START(x, y) int WINAPI wWinMain(HINSTANCE hInstance,	HINSTANCE hPrevInstance,PWSTR pCmdLine,int nCmdShow){	Main win;	if (win.CreateWin(hInstance, x, y))	{		win.GameRun();	}	return 0;}
